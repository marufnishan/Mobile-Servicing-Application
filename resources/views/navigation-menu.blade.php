        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-5 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('allnotice') }}" :active="request()->routeIs('allnotice')" style="text-decoration: none">
                        {{ __('Our Services') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('notice') }}" :active="request()->routeIs('notice')" style="text-decoration: none">
                        @if(Auth::user()->utype === 'Admin')
                        {{ __('Add New Service') }}
                        @endif
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('allusers') }}" :active="request()->routeIs('allusers')" style="text-decoration: none">
                        @if(Auth::user()->utype === 'Admin')
                        {{ __('All Orders') }}
                        @endif
                    </x-jet-nav-link>
